...
template<typename Key, typename Value, typename Hash = frg::hash<Key>, typename Allocator = frg::stl_allocator>
class hash_map {
public:
...
public:
  ...
  constexpr hash_map(Hash &&hasher, Allocator allocator = Allocator());
...
template<typename Key, typename Value, typename Hash, typename Allocator>
constexpr hash_map<Key, Value, Hash, Allocator>::hash_map(Hash &&hasher,
                                                          Allocator allocator)
    : _hasher(hasher), _allocator(std::move(allocator)), _table(nullptr), _capacity(0), _size(0) { }
...
template<typename Key, typename Value, typename Hash, typename Allocator>
hash_map<Key, Value, Hash, Allocator>::hash_map()
: _hasher(frg::hash<Key>()), _allocator(frg::stl_allocator()), _table(nullptr), _capacity(0), _size(0){
