...
public:
	...
	public:
		explicit iterator(borrow_pointer current)
		: _current(current) { }
...
public:
  using ListType = typename frg::intrusive_list<
      item,
      frg::locate_member<
          item,
  ...
  using iterator = typename ListType::iterator;
	...
	: allocator_{std::move(allocator)}, items_() { }
